...
data <- 
    ...
    mutate(avg_rating_cat = if_else(avg_rating > 4.85, "good", "bad")) %>%
...
data_split <- initial_split(data, strata = avg_rating)
...
folds <- vfold_cv(data_train, strata = avg_rating)
```
